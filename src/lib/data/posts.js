...
export const posts = [
    ...
    },
    {
        ...
        <figure class="blog-figure">
            ...
            <figcaption>Start with a knot.</figcaption>
        </figure>
        ...
        <figure class="blog-figure">
            ...
            <figcaption>Pinch and pull a loop through the existing loop.</figcaption>
        </figure>
        ...
        <figure class="blog-figure">
            ...
            <figcaption>Keep going until you have a chain.</figcaption>
        </figure>
    ...
    },
    {
        ...
        <figure class="blog-figure">
            ...
            <figcaption>It can be difficult at first, but I figured it out.</figcaption>
        </figure>
    ...
    },
    {
        ...
        <figure class="blog-figure">
            ...
            <figcaption>It's always good to use a reference. I saw a picture of a flower nearby.</figcaption>
        </figure>
